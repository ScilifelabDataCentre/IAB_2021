...
trend_data_aff_sub = trend_data_aff[
    (trend_data_aff["Publication_year"] > 2012)
...
# cats_13 = trend_data_aff[(trend_data_aff["Publication_year"] == 2013)]
# cats_14 = trend_data_aff[(trend_data_aff["Publication_year"] == 2014)]
# cats_15 = trend_data_aff[(trend_data_aff["Publication_year"] == 2015)]
# cats_16 = trend_data_aff[(trend_data_aff["Publication_year"] == 2016)]
# cats_17 = trend_data_aff[(trend_data_aff["Publication_year"] == 2017)]
# cats_18 = trend_data_aff[(trend_data_aff["Publication_year"] == 2018)]
...
# number_papers = len(trend_data_aff_sub["UT"].unique())
# print(number_papers)

trend_data_aff_sub_field = trend_data_aff_sub[
    (trend_data_aff_sub["Subject_category"] == "BIOCHEMICAL RESEARCH METHODS")
    | (trend_data_aff_sub["Subject_category"] == "BIOCHEMISTRY & MOLECULAR BIOLOGY")
    | (trend_data_aff_sub["Subject_category"] == "BIOTECHNOLOGY & APPLIED MICROBIOLOGY")
    | (trend_data_aff_sub["Subject_category"] == "ONCOLOGY")
    | (trend_data_aff_sub["Subject_category"] == "CELL BIOLOGY")
    | (trend_data_aff_sub["Subject_category"] == "GENETICS & HEREDITY")
]

trend_group = (
    trend_data_aff_sub_field.groupby(["Publication_year", "Subject_category"])
...
total_papers = trend_data_aff_sub.drop_duplicates(subset="UT", keep="first")
year_group = (
...
if not os.path.isdir("Plots/"):
    os.mkdir("Plots/")
# fig.show()
fig.write_image("Plots/affiliates_trends_arttypes.svg")
fig.write_image("Plots/affiliates_trends_arttypes.png")
