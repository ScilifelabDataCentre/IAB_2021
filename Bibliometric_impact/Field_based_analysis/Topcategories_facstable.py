...
# fig3.show()
fig3.update_layout(autosize=False, margin={"l": 0, "r": 0, "t": 0, "b": 0}, height=330)
fig3.write_image("Plots/UPDATE1518/summary_table_facs_arttypes.png")
fig3.write_image("Plots/UPDATE1518/summary_table_facs_arttypes.svg")
trend_group.to_excel("Plots/UPDATE1518/summary_table_facs_arttypes_data.xlsx")
