""" This makes the data prepared from affiliates. 
This is slightly different because this data file comes from KTH-B.
 Fells and facs come from pub database"""

import pandas as pd

Pubs_JIF_raw = pd.read_excel(
    "DataforJIF/SciLifeLab-byaddress-20210512.xlsx",
...
# Need to filter raw pubs (2013-20 for IAB 2021)

Pubs_JIF_raw = Pubs_JIF_raw[
    (Pubs_JIF_raw["Publication_year"] > 2012)
    & (Pubs_JIF_raw["Publication_year"] < 2021)
]
