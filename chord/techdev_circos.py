...
from fac_map import fac_map
from filter_techdev import techdev_df

unit = techdev_df["Labels"].str.split("|")
unit = unit.tolist()
...
labels = [
    # "Compute and Storage", # OO asked that this always excluded (also all service)
...
def make_ribbon_arc(theta0, theta1):
    ...
    if test_2PI(theta0) and test_2PI(theta1):
        if theta0 < theta1:
            ...
            if theta0 * theta1 > 0:  # was originally 0 changed to 10 to stop this error
