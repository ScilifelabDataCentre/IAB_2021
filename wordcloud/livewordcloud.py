...
# imports the .json from the publications library : https://publications-covid19.scilifelab.se/label/Funder%3A%20KAW/SciLifeLab.json (will give just scilifelab funded papers)
