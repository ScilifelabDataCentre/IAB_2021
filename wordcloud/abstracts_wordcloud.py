"""This script generates all the wordclouds involving abstracts for IAB 2021 report"""
...
import numpy as np
import os
from abstract_data_prep import (
    year1,
    year2,
    Fellows_data_range,
    Fellows_data_year1,
...
def makeabstractwordcloud(data, Thresh_num, group_name, stopwords):
    wordcloud = WordCloud(
    ...
    if not os.path.isdir("Plots/Abstractclouds"):
        os.mkdir("Plots/Abstractclouds")
    # savefig will save the figure (at resolution 300dpi - good enoough for print)
    plt.savefig(
        "Plots/Abstractclouds/{}_abstractwordcloud.png".format(group_name), dpi=300
    )
...
# makeabstractwordcloud(
#     abstract_words_fell_range, 10, "fell_abstract_2years", stopwords_fell
# )
# makeabstractwordcloud(
#     abstract_words_fell_year1, 10, "fell_abstract_{}".format(year1), stopwords_fell
# )
# makeabstractwordcloud(
#     abstract_words_fell_year2, 10, "fell_abstract_{}".format(year2), stopwords_fell
# )
# makeabstractwordcloud(
#     abstract_words_fac_range, 10, "fac_abstract_2years", stopwords_fac
# )
# makeabstractwordcloud(
#     abstract_words_fac_year1, 10, "fac_abstract_{}".format(year1), stopwords_fac
# )
# makeabstractwordcloud(
#     abstract_words_fac_year2, 10, "fac_abstract_{}".format(year2), stopwords_fac
# )
makeabstractwordcloud(
    abstract_words_aff_range, 10, "aff_abstract_2years", stopwords_aff
)
makeabstractwordcloud(
    abstract_words_aff_year1, 10, "aff_abstract_{}".format(year1), stopwords_aff
)
makeabstractwordcloud(
    abstract_words_aff_year2, 10, "aff_abstract_{}".format(year2), stopwords_aff
)
