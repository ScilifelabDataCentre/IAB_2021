...
Fellows_data = Fellows_data.rename(columns={"Keyword list": "keyword_list"})
...
# fellows keywords for date range and invidiual years
for val in Fellows_data_range.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_fell_range += " ".join(tokens) + " "
for val in Fellows_data_year1.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_fell_year1 += " ".join(tokens) + " "
for val in Fellows_data_year2.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_fell_year2 += " ".join(tokens) + " "
...
Facilities_data = Facilities_data.rename(columns={"Keyword list": "keyword_list"})
...
# pick the column you want to import words from df.columnname
for val in Facilities_data_range.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_fac_range += " ".join(tokens) + " "
for val in Facilities_data_year1.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_fac_year1 += " ".join(tokens) + " "
for val in Facilities_data_year2.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_fac_year2 += " ".join(tokens) + " "
...
Affiliates_data = Affiliates_data.rename(columns={"Keyword list": "keyword_list"})
...
# pick the column you want to import words from df.columnname
for val in Affiliates_data_range.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_aff_range += " ".join(tokens) + " "
for val in Affiliates_data_year1.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_aff_year1 += " ".join(tokens) + " "
for val in Affiliates_data_year2.keyword_list:
    val = str(val)
    tokens = val.split()
    key_words_aff_year2 += " ".join(tokens) + " "
