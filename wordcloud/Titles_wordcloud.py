"""This script generates all the wordclouds involving titles for IAB 2021 report"""
...
def maketitlewordcloud(data, Thresh_num, group_name, stopwords):
    wordcloud = WordCloud(
    ...
    if not os.path.isdir("Plots/Titleclouds"):
        os.mkdir("Plots/Titleclouds")
    # savefig will save the figure (at resolution 300dpi - good enoough for print)
    plt.savefig("Plots/Titleclouds/{}_titleswordcloud.png".format(group_name), dpi=300)
